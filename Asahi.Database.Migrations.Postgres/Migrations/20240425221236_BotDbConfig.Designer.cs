...
namespace Asahi.Migrations.Postgres.Migrations
{
    ...
    [Migration("20240425221236_BotDbConfig")]
    partial class BotDbConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Asahi.Database.Models.TrustedId", b =>
                {
                    ...
                    b.Property<bool?>("BotWideConfigDumbKey")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("BotWideConfigDumbKey");
            ...
            modelBuilder.Entity("Asahi.Database.Models.TrustedId", b =>
                {
                    b.HasOne("Asahi.Database.Models.BotWideConfig", null)
                        .WithMany("TrustedIds")
                        .HasForeignKey("BotWideConfigDumbKey");
                });
