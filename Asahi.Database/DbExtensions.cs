...
public static class DbExtensions
{
    ...
    public static async Task InitializeAsync(this BotDbContext context, bool migrationEnabled)
    {
        if (migrationEnabled)
        {
    ...
    public static async Task ResetDatabaseAsync(this BotDbContext context)
    {
